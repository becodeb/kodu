...
> = {
  ...
  // — se lo está probando solo, en un iframe que el docente no ve, antes de
  // soltarlo. Misma sensación de "weaving" que "Armando el recurso".
